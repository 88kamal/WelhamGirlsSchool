            ...
            <section className="our-team team-page sec-pad1">
                <div className="container">
                    <div className="team-title centred">
                        ...
                        <img src="images/SCHOLARSHIPS.jpeg" alt="" />
                    </div>
                    <div className="row">
                        <div className="page-content">
                            ...
                            <p style={{
                                ...
                                Different types of scholarships are available for students, including those based on financial need. These types of scholarships are typically easier to get because they do not require as much work on behalf of the student as other types of scholarship applications.
                                Scholarships are noteworthy because they help students who would otherwise have to drop out of school or forgo higher education to continue their education.
                                Scholarships also allow those unable to attend a specific school due to geographic limitations but are capable of following another college, the opportunity to do so.
                                The scholarships at Welham Girls' School help increase diversity on campuses by giving students from disadvantaged backgrounds the chance to attend colleges and universities that they might not otherwise be able to afford.
                                <br />
                                Scholarships are available on parent-submitted applications, and recipients are chosen based on financial need and academic merit. The scholarship amounts are chosen after determining the parents' total income, and the recipients are announced after the scholarship committee has carefully reviewed all pertinent paperwork. Much of the School expenses are covered by scholarships.
                                Scholarship applications from parents of pupils hoping to enrol in Welham Girls' School the following year are also accepted. Every year, scholarships undergo revisions, and one must submit new applications. Every year, parents of students who desire to apply for a scholarship must ask the institution for the relevant form.
                            </p>
