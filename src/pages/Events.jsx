...
function Events() {
    ...
    return (
        <section className="image-gallery sec-pad">
            <div className="container addmission1 margin">
                        ...
                        <div className="row">
                            <div className="col-md-3 my-2 ">
                                <div className="card bg-light p-2 " >
                                    <img src="images/home/3.jpg" className="card-img-top img-thumbnail rounded-4 event-img event_hover" alt='img' />
                            ...
                            <div className="col-md-3 my-2 ">
                                <div className="card bg-light p-2 " >
                                    <img src="images/home/1.jpg" className="card-img-top event_hover img-thumbnail rounded-4 event-img" alt='img' />
                                    <div className="c">
                                        <div className="mx-2">
                            ...
                            <div className="col-md-3 my-2 ">
                                <div className="card bg-light p-2 " >
                                    <img src="images/home/4.jpg" className="card-img-top img-thumbnail rounded-4 event_hover event-img" alt='img' />
                                    <div className="">
                                        <div className="mx-2">
                            ...
                            <div className="col-md-3 my-2 ">
                                <div className="card bg-light p-2 " >
                                    <img src="images/home/2.jpg" className="card-img-top img-thumbnail event_hover rounded-4 event-img" alt='img' />
                                    <div className="">
                                        <div className="mx-2">
