                ...
                <div className="collapse navbar-collapse  " id="navbarSupportedContent">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0 mx-auto  ">
                        <li className="nav-item  ">
                            <Link to={'/'} className="nav-link fw-light hover-home  ">Home
                            </Link>
                        </li>
                        <li className="nav-item dropdown">
                            <a href='/' className="nav-link dropdown-toggle fw-light " role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                About Us
                            </a>
                        ...
                        <li className="nav-item">
                            <Link to={'/news'} className="nav-link fw-light">News
                            </Link>
                        </li>
                        <li className="nav-item dropdown">
                            <a href='/' className="nav-link dropdown-toggle fw-light" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <ul className="dropdown-menu rounded-0 ">
                                <li><Link to={'/events'} className="dropdown-item ">Events</Link>
                                </li>
                                <li><Link to={'/event-details'} className="dropdown-item ">Event Details</Link>
                                </li>
                        ...
                        <li className="nav-item">
                            <Link to={'/contact'} className="nav-link  fw-light" aria-current="page" >Contact</Link>
                        </li>
                    </ul>
                </div>
            </div>
